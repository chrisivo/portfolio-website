...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hi, I&apos;m Chris.</span> I&apos;m a int
        <span className="font-bold">Freelance Software Engineer</span> with{" "}
        <span className="font-bold">over 25 years</span> of experience,
        passionate about{" "}
      ...
      >
        ...
        <a
          ...
          href="/downloads/CIveson-CV-20231116-Public-3.pdf"
          download
        >
          Download CV{" "}
        ...
        <a
          ...
          href="https://www.linkedin.com/in/chris-iveson-0151776"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        <a
          ...
          href="https://github.com/chrisivo"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
